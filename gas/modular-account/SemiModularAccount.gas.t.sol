...
contract ModularAccountGasTest is ModularAccountBenchmarkBase("SemiModularAccount") {
    ...
    function test_semiModularAccountGas_userOp_nativeTransfer() public {
        ...
        userOp.signature = _encodeSignature(signerValidation, GLOBAL_VALIDATION, abi.encodePacked(EOA_TYPE_SIGNATURE, r, s, v));
    ...
    function test_semiModularAccountGas_userOp_useSessionKey_case1_counter() public {
        ...
        userOp.signature =
            _encodeSignature(sessionKeyValidation, SELECTOR_ASSOCIATED_VALIDATION, abi.encodePacked(EOA_TYPE_SIGNATURE, r, s, v));

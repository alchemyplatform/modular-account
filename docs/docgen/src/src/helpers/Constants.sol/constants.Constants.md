# Constants
[Git Source](https://github.com/ssh://alchemyplatform/modular-account/blob/a15fd11665cc3bcdef40d456208c0f7907b5a3eb/src/helpers/Constants.sol)
...
### FALLBACK_VALIDATION_ID

```solidity
uint32 constant FALLBACK_VALIDATION_ID = uint32(0);
```

### FALLBACK_VALIDATION_LOOKUP_KEY

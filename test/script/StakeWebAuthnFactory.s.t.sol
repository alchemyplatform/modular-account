...
import {StakeWebAuthnFactoryScript} from "../../script/StakeWebAuthnFactory.s.sol";
...
contract StakeWebAuthnFactoryTest is OptimizedTest {
    StakeWebAuthnFactoryScript internal _stakeFactoryScript;
    ...
    function setUp() public {
        ...
        _accountFactory = new WebAuthnFactory(
            _entryPoint,
        ...
        vm.setEnv("WEBAUTHN_ACCOUNT_FACTORY_TO_STAKE", vm.toString(address(_accountFactory)));
    }
